...
<div class="father">
    <div class="mb-3 pt-4 mm"> 
        <a href="{{ route('posts.create') }}">
            <button type="button" class="btn btn-primary ml col-up inpp haha"><p class="mdi--application-edit-outline mb-0 mr-4"></p>Add New Post </button>
                                ...
                                @if ($images)
                                    <div class="post-images">
                                        @foreach ($images as $image)
                                            <img src="{{ asset('images/posts/' . $image) }}" alt="Image for post" class="img-fluid mb-2 im">
                                        @endforeach
                                    </div>
                                @endif
